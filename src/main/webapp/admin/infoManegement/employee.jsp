...
<table class="layui-hide" id="test" lay-filter="test"></table>
  ...
  <div class="layui-btn-container" style="padding-left:20px;">
	...
	<input type="text" placeholder="请输入用户" class="layui-text"  id="select" style="width:150px;height:30px;">
	<button class="layui-btn layui-btn-sm  layui-btn-normal" lay-event="select"><i class="layui-icon layui-icon-search"></i>搜索</button>
  </div>
