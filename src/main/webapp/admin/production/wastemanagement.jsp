...
layui.use(['table','form','laydate'], function(){
  ...
  table.render({
    elem: '#test'
    ,url:'${APP_PATH }/selectWasteManagement.do'
    ,toolbar: '#toolbarDemo'
    ,title: '废料数据表'
    ,cols: [[
      {type: 'checkbox', fixed: 'left'}
      ,{field:'wasteId', title:'ID', fixed: 'left', unresize: true, sort: true}
      ,{field:'proName', title:'废料名称', edit: 'text'}
      ,{field:'wasteQuantity', title:'废料数量', sort: true}
      ,{field:'applydate', title:'加入时间'}
      ...
      case 'getCheckData':
    		if (data.length == 1) {
      			...
      			if (data[0].status=='未审核') {
      				var index2 = layer.confirm('你确认审核该废料单？', {
      			...
      			layer.msg('一次只能审核一个废料');
      		} else {
      			layer.msg('请选择一件要审核的废料');
